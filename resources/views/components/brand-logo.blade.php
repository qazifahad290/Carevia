<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 40" {{ $attributes }}>
    <g>
        <rect width="40" height="40" rx="11" fill="#5B2EE6"/>
    ...
    <text x="52" y="27" font-family="Inter, sans-serif" font-size="22" font-weight="800" fill="#0F0B1F" letter-spacing="-0.5">Carevia</text>
</svg>
