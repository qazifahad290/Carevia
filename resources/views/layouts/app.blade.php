...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen flex flex-col">
        ...
        <footer class="bg-white border-t border-gray-100 mt-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-ink-500">
                <div class="flex items-center gap-3">
                    <x-brand-logo class="h-8" />
                    <span class="text-ink-500">· Trusted doctor appointments, made simple.</span>
                </div>
                <div>© {{ date('Y') }} Carevia. All rights reserved.</div>
            </div>
        </footer>
    </body>
</html>
